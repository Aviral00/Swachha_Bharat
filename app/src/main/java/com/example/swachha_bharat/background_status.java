...
public class background_status extends AsyncTask<String, Void, String> {
    ...
    public background_status(Context context)
    {
    ...
    protected String doInBackground(String... voids) {
        String result = "";
        String cid = voids[0];
        String connstr = "https://192.168.0.115/status.php";
